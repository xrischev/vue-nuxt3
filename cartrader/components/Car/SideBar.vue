...
<template>
  ...
  <div class="shadow border w-64 mr-10 z-30 h-[190px]">
    ...
    <div class="p-5 flex justify-between relative cursor-pointer border-b">
      ...
      <div class="absolute shadow left-56 p-5 top-1 -m-1 w-[600px] flex justify-between flex-wrap bg-white" v-if="modal.make">
    ...
    <div class="p-5 flex justify-between relative cursor-pointer border-b">
      <h3 @click="updateModal('price')">
       Price  <span class="text-blue-400 capitalize">
        {{priceRangeText}}
      </span>
      </h3>
