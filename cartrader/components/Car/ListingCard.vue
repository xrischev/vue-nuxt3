...
// Define a computed property for the image URL
const imageUrl = computed(() => `https://ebyzvgcndvsswontgtdk.supabase.co/storage/v1/object/public/images/${props.listing.image}`);
</script>
